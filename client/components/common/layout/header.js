                                    ...
                                    <li>
                                        <ul className="menu">
                                            <li>
                                                <a href="/">
                                                    <div className="pull-left">
                                                        <img src="js/theme/img/user2-160x160.jpg" className="img-circle" alt="User"/>
                                                    </div>
                                                    <h4>
                                                        Support Team
                                            ...
                                            <li>
                                                <a href="/">
                                                    <div className="pull-left">
                                                        <img src="js/theme/img/user3-128x128.jpg" className="img-circle" alt="User"/>
                                                    </div>
                                                    <h4>
                                            ...
                                            <li>
                                                <a href="/">
                                                    <div className="pull-left">
                                                        <img src="js/theme/img/user4-128x128.jpg" className="img-circle" alt="User"/>
                                                    </div>
                                                    <h4>
                                                        Developers
